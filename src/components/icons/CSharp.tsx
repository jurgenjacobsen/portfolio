export default function CSharpIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg
            ...
            {...props}
        >
            <g clip-path="url(#csharp-icon-clip)">
                <path
                    fill="#a179dc"
                ...
                <path
                    fill="#fff"
                    d="M50.603 16.884c12.203 0 22.857 6.627 28.563 16.478l-.056-.095-14.357 8.267c-2.828-4.79-8.014-8.022-13.963-8.088l-.187-.001c-9.071 0-16.426 7.353-16.426 16.425 0 2.966.791 5.747 2.167 8.149 2.83 4.943 8.153 8.277 14.259 8.277 6.143 0 11.496-3.377 14.313-8.372l-.068.12 14.335 8.305C73.54 76.116 63.031 82.722 50.97 82.854l-.367.002c-12.241 0-22.925-6.668-28.618-16.57a32.84 32.84 0 0 1-4.368-16.416c0-18.217 14.768-32.986 32.986-32.986"
                />
            </g>
            <defs>
                <clipPath id="csharp-icon-clip">
