    ...
    return <>
        <nav className="rounded-xl bg-card py-3 px-8 flex justify-between items-center shadow-md border border-border">
            ...
            <ul className="flex gap-4">
                <NavbarButton href="/">
                    <HomeIcon className="size-4 group-hover:scale-105 transition-transform" /> Home
                </NavbarButton>
                ...
                <NavbarButton href="/contact">
                    <Contact2Icon className="size-4 group-hover:scale-105 transition-transform" /> Contact
                </NavbarButton>
                <NavbarButton href="/about">
                    <InfoIcon className="size-4 group-hover:scale-105 transition-transform" /> About
                </NavbarButton>
            </ul>
        </nav>
    </>
