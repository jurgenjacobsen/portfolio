                ...
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-4 border-b border-border">
                    ...
                    <div className="flex flex-wrap items-center gap-2 pt-2 md:pt-0 no-print animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both">
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 h-9 px-4 text-sm font-medium rounded-full bg-primary text-primary-foreground hover:bg-primary/80 transition-colors cursor-pointer"
                        >
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 h-9 px-4 text-sm font-medium rounded-full border border-border bg-background hover:bg-muted hover:text-foreground transition-colors cursor-pointer"
                        >
                        ...
                        <button
                            type="button"
                            onClick={handlePrint}
                            className="inline-flex items-center justify-center gap-2 h-9 px-4 text-sm font-medium rounded-full border border-border bg-background hover:bg-muted hover:text-foreground transition-colors cursor-pointer hidden sm:inline-flex"
